export const PREPARED_RESPONSES = [
    ...
    'Connecting to the NeoAPI mainframe...',
    'Initializing quantum processors...',
    'Synchronizing with the digital collective...'
  ]
  
  export const SYSTEM_INSTRUCTION = `You are an AI assistant in a cyberpunk-themed chat interface. 
  ...
  // Обновим тип для processWithGrog
  export interface ProcessWithGrogOptions {
    message: string;
